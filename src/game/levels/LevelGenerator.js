...
const CEILING_OVERHANGS = [
  ...
  { start: 780, width: 60, clearance: 150 },
  { start: 860, width: 40, clearance: 150 },
  { start: 1140, width: 70, clearance: 150 },
  { start: 1240, width: 50, clearance: 150 },
  { start: 1430, width: 60, clearance: 150 },
  { start: 1560, width: 40, clearance: 150 },
  { start: 1710, width: 60, clearance: 150 },

  // Chapter 2: Mid-section gauntlets (1800-3200)
  { start: 2000, width: 60, clearance: 150 },
  { start: 2150, width: 80, clearance: 150 },
  { start: 2320, width: 60, clearance: 150 },
  { start: 2520, width: 70, clearance: 150 },
  { start: 2660, width: 60, clearance: 150 },
  { start: 2840, width: 70, clearance: 150 },
  { start: 3000, width: 60, clearance: 150 },
  { start: 3140, width: 60, clearance: 150 },

  // Chapter 3: Late-section choke points (3200-5000)
  { start: 3290, width: 80, clearance: 150 },
  { start: 3460, width: 60, clearance: 150 },
  { start: 3620, width: 60, clearance: 150 },
  { start: 3780, width: 70, clearance: 150 },
  { start: 3940, width: 60, clearance: 150 },
  { start: 4100, width: 70, clearance: 150 },
  { start: 4300, width: 70, clearance: 150 },
  { start: 4460, width: 60, clearance: 150 },
  { start: 4660, width: 80, clearance: 150 },
  { start: 4820, width: 60, clearance: 150 },
  { start: 4980, width: 70, clearance: 150 },
  { start: 5160, width: 60, clearance: 150 },
  { start: 5340, width: 70, clearance: 150 },
  { start: 5520, width: 60, clearance: 150 },
  { start: 5700, width: 70, clearance: 150 },
  { start: 5880, width: 60, clearance: 150 },
  { start: 6060, width: 70, clearance: 150 },
  { start: 6240, width: 60, clearance: 150 },
  { start: 6420, width: 70, clearance: 150 },
  { start: 6600, width: 60, clearance: 150 },
  { start: 6780, width: 80, clearance: 150 },
  { start: 6960, width: 60, clearance: 150 },
  { start: 7140, width: 70, clearance: 150 },
  { start: 7320, width: 60, clearance: 150 },
  { start: 7500, width: 70, clearance: 150 },
  { start: 7680, width: 60, clearance: 150 },
  { start: 7860, width: 70, clearance: 150 },
  { start: 8040, width: 60, clearance: 150 },
  { start: 8220, width: 70, clearance: 150 },
  { start: 8400, width: 60, clearance: 150 },
  { start: 8580, width: 70, clearance: 150 },
  { start: 8760, width: 60, clearance: 150 },
  { start: 8940, width: 70, clearance: 150 },
  { start: 9120, width: 60, clearance: 150 },
  { start: 9300, width: 70, clearance: 150 },
  { start: 9480, width: 60, clearance: 150 },
  { start: 9660, width: 70, clearance: 150 },
];
